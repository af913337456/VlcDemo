...
import com.myvlc.R;
import com.myvlc.UILApplication;
...
import bananacloud.IAudioService;
import bananacloud.IAudioServiceCallback;
...
public class AudioService extends Service {
    ...
    public void onCreate() {
        ...
        filter.addAction(UILApplication.INCOMING_CALL_INTENT);
        filter.addAction(UILApplication.CALL_ENDED_INTENT);
    ...
    public void setUpRemoteControlClient() {
        Context context = UILApplication.getAppContext();
    ...
    private final BroadcastReceiver serviceReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
             ...
             */
            if (action.equalsIgnoreCase(UILApplication.INCOMING_CALL_INTENT)) {
             ...
             */
            if (action.equalsIgnoreCase(UILApplication.CALL_ENDED_INTENT)
                    && mWasPlayingAudio) {
                play();
            }
             ...
             * Sleep
             */
            if (action.equalsIgnoreCase(UILApplication.SLEEP_INTENT)) {
                stop();
            }
        }
    };
    ...
    private final IAudioService.Stub mInterface = new IAudioService.Stub() {
         ...
         */
        @Override
        public void load(List<String> mediaPathList, int position, boolean noVideo)throws RemoteException {
