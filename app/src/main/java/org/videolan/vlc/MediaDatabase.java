...
public class MediaDatabase {
    ...
    public synchronized static MediaDatabase getInstance() {
        if (instance == null) {
            instance = new MediaDatabase(UILApplication.getAppContext());
        }
        return instance;
    }
    ...
    private class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public SQLiteDatabase getWritableDatabase() {
            ...
            try {
                ...
                try {
                    db = SQLiteDatabase.openOrCreateDatabase(UILApplication.getAppContext().getDatabasePath(DB_NAME), null);
