...
public class Util {
    ...
    public static int convertPxToDp(int px) {
        DisplayMetrics metrics = UILApplication.getAppResources().getDisplayMetrics();
    ...
    public static int convertDpToPx(int dp) {
        return Math.round(
                TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, dp,
                        UILApplication.getAppResources().getDisplayMetrics())
                );
    }

    public static String readAsset(String assetName, String defaultS) {
        try {
            InputStream is = UILApplication.getAppResources().getAssets().open(assetName);
